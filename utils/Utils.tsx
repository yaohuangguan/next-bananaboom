...
export const flipTarget = target => {
  const rollTarget = document.querySelector(target);
  rollTarget.classList.add("animated", "rotateIn");
  rollTarget.addEventListener("animationend", () =>
    rollTarget.classList.remove("animated", "rotateIn")
  );
};

export function getLoading(fillColor) {
  return (
    <>
